<?php
namespace JS\JsGuestbook\Utility\Hook;
...
/**
 * Show Plugin Information in Page Module to every js_guestbook content element
 *
 * @package JS\JsGuestbook\Utility\Hook
...
class PluginInformation {
	 ...
	 * @var string
	 */
	protected $locallangPath = 'LLL:EXT:js_guestbook/Resources/Private/Language/locallang-plugin-information.xlf:';
	...
	public function build($params = array()) {
		...
		$imagePath = $this->getSubFolderOfCurrentUrl().'typo3conf/ext/js_guestbook/Resources/Public/Icons/plugin-information.png';
	...
	protected function buildImage($resourcePathAndFilename) {
		$imagePathAndFilename = $this->getSubFolderOfCurrentUrl().'typo3conf/ext/js_guestbook/Resources/Public/Images/';
